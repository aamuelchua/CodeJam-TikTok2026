...
**Webinar Recording:** [#4 Shopping Copilot: AI Conversational Search and Recommendations.mp4](https://bytedance.larkoffice.com/wiki/JlBHwciINiC3RCkfJ6xcuCGZnzb)
...
- **Pipeline Base**: Construct an in-memory data stream featuring **"Multi-Route Retrieval** $$\rightarro$$ **LLM Semantic Ranking"** (combining keyword, category, and vector similarity).
...
- Participant repository: [https://github.com/TechJam2026/techjam-conversational-search](https://github.com/TechJam2026/techjam-conversational-search)
    
- Participant Kit Release: [https://github.com/TechJam2026/techjam-conversational-search/releases/tag/participant-kit](https://github.com/TechJam2026/techjam-conversational-search/releases/tag/participant-kit)
    
- Original data source and documentation: [https://amazon-reviews-2023.github.io/](https://amazon-reviews-2023.github.io/)
...
6. **Written Project Description (via Devpost)**
